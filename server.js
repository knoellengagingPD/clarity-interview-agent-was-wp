...
// Canonical question text for the survey-invitation email.
//
// GENERATED from workplace-interview-agent/src/lib/interview/roles/*.ts —
// the survey modules are the single source of truth. Do not hand-edit: if a
// question changes there, regenerate this block, or the invitation email will
// list statements participants never hear. On 2026-08-27 this block was three
// questions and one whole ordering behind the live surveys.
const CLIMATE_QUESTIONS = {
  students: [
    { n: 1 , text: 'I feel safe at this school.', open: false },
    { n: 2 , text: 'This school is prepared to handle an emergency.', open: false },
    { n: 3 , text: 'Teachers and staff treat students with respect.', open: false },
    { n: 4 , text: 'Students treat each other with respect.', open: false },
    { n: 5 , text: 'This school supports students of different backgrounds and identities.', open: false },
    { n: 6 , text: 'If I report bullying, in person or online, an adult will do something about it.', open: false },
    { n: 7 , text: 'Students at this school are disciplined fairly, no matter who they are.', open: false },
    { n: 8 , text: 'Alcohol and drug use is rare at this school.', open: false },
    { n: 9 , text: 'When someone raises a concern here, it is taken seriously.', open: false },
    { n: 10, text: 'I feel like I belong at this school.', open: false },
    { n: 11, text: 'When I am upset, adults at this school show they care.', open: false },
    { n: 12, text: 'If I needed help with how I was feeling, I could get it at this school.', open: false },
    { n: 13, text: 'My input is valued when decisions are made.', open: false },
    { n: 14, text: 'My teachers give me feedback that helps me get better.', open: false },
    { n: 15, text: 'Adults at this school expect every student to do well.', open: false },
    { n: 16, text: 'This school has the resources and materials I need to learn.', open: false },
    { n: 17, text: 'How well does your school help you understand how to use AI tools, like ChatGPT, the right way for schoolwork?', open: false },
    { n: 18, text: 'Overall, this is a good school.', open: false },
    { n: 19, text: 'If you could change one or two things to make school better for everyone, what would they be?', open: true },
    { n: 20, text: 'What is one thing about your school that you really love and never want to change?', open: true },
    { n: 21, text: 'Where do you think AI could help you with schoolwork or learning — and where does it worry you or cause problems?', open: true },
  ],
  teachers: [
    { n: 1 , text: 'I feel safe at this school.', open: false },
    { n: 2 , text: 'This school is prepared to handle an emergency.', open: false },
    { n: 3 , text: 'Teachers and staff treat students with respect.', open: false },
    { n: 4 , text: 'Students treat teachers with respect.', open: false },
    { n: 5 , text: 'When in-person or online bullying is reported at this school, it gets resolved.', open: false },
    { n: 6 , text: 'Students at this school are disciplined fairly, no matter who they are.', open: false },
    { n: 7 , text: 'Alcohol and drug use is rare at this school.', open: false },
    { n: 8 , text: 'I am comfortable reporting safety concerns to administrators.', open: false },
    { n: 9 , text: 'When someone raises a concern here, it is taken seriously.', open: false },
    { n: 10, text: 'I feel like I belong at this school.', open: false },
    { n: 11, text: 'I consistently have enough emotional energy to meet the demands of my students and colleagues.', open: false },
    { n: 12, text: 'My input is valued when decisions are made.', open: false },
    { n: 13, text: 'Communication among staff is open and honest.', open: false },
    { n: 14, text: 'I receive feedback that helps me grow as an educator.', open: false },
    { n: 15, text: 'Adults at this school expect every student to do well.', open: false },
    { n: 16, text: 'I have access to adequate instructional materials and resources.', open: false },
    ...
    { n: 19, text: 'Overall, this is a good school.', open: false },
    { n: 20, text: 'If funding were not a barrier, what one or two practical changes would most improve teaching and learning at this school?', open: true },
    { n: 21, text: 'What is one thing this school does really well that you never want to change?', open: true },
    { n: 22, text: 'Where do you think AI could be most helpful in your school — and where do you have concerns about it being used?', open: true },
  ],
  staff: [
    { n: 1 , text: 'I feel safe at this school.', open: false },
    { n: 2 , text: 'This school is prepared to handle an emergency.', open: false },
    { n: 3 , text: 'Teachers and staff treat students with respect.', open: false },
    { n: 4 , text: 'Students treat staff members with respect.', open: false },
    { n: 5 , text: 'Students treat each other with respect.', open: false },
    { n: 6 , text: 'Bullying, in person or online, is rare at this school.', open: false },
    { n: 7 , text: 'Students at this school are disciplined fairly, no matter who they are.', open: false },
    { n: 8 , text: 'Alcohol and drug use is rare at this school.', open: false },
    { n: 9 , text: 'I am comfortable reporting safety concerns to administrators.', open: false },
    { n: 10, text: 'When someone raises a concern here, it is taken seriously.', open: false },
    { n: 11, text: 'I feel like I belong at this school.', open: false },
    { n: 12, text: 'I feel supported by the school administration.', open: false },
    { n: 13, text: 'My input is valued when decisions are made.', open: false },
    { n: 14, text: 'Communication among staff is open and honest.', open: false },
    { n: 15, text: 'Adults at this school expect every student to do well.', open: false },
    { n: 16, text: 'I have the materials and supplies I need to perform my job effectively.', open: false },
    { n: 17, text: 'How prepared do you feel your school is to use AI tools thoughtfully to support day-to-day school operations, like communication, scheduling, or administrative tasks?', open: false },
    { n: 18, text: 'Overall, this is a good school.', open: false },
    { n: 19, text: 'If funding were not a barrier, what one or two changes would most improve the experience of staff and students at this school?', open: true },
    { n: 20, text: 'What is one thing about working at this school that you value most and never want to change?', open: true },
    { n: 21, text: 'Where do you think AI could be most helpful in how your school operates — and where do you have concerns about it being used?', open: true },
  ],
  parents: [
    { n: 1 , text: 'My child feels safe at school.', open: false },
    { n: 2 , text: 'This school is prepared to handle an emergency.', open: false },
    { n: 3 , text: 'Teachers and staff treat students with respect.', open: false },
    { n: 4 , text: 'Students from different backgrounds are respected at this school.', open: false },
    { n: 5 , text: 'The school deals effectively with bullying, in person or online.', open: false },
    { n: 6 , text: 'Students at this school are disciplined fairly, no matter who they are.', open: false },
    { n: 7 , text: 'Alcohol and drug use is rare at this school.', open: false },
    { n: 8 , text: 'I am comfortable reporting safety concerns to administrators.', open: false },
    { n: 9 , text: 'I feel welcome at my child\'s school.', open: false },
    { n: 10, text: 'The teachers at this school care about my child.', open: false },
    { n: 11, text: 'My input is valued when decisions are made.', open: false },
    { n: 12, text: 'The school keeps me informed about my child\'s academic progress.', open: false },
    { n: 13, text: 'School staff respond promptly to my questions and concerns.', open: false },
    { n: 14, text: 'Adults at this school expect every student to do well.', open: false },
    { n: 15, text: 'My child has access to the resources needed to succeed at school.', open: false },
    ...
    { n: 17, text: 'Overall, this is a good school.', open: false },
    { n: 18, text: 'If funding were not a barrier, what one or two changes would most improve your child\'s experience at this school?', open: true },
    { n: 19, text: 'What is one thing this school does really well for students and families that you never want to change?', open: true },
    { n: 20, text: 'Where do you see AI potentially helping your child\'s education — and where do you have concerns about how it\'s being used?', open: true },
  ],
};
      ...
      <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(99,102,241,0.10);">
        ...
        <tr>
          <td style="padding:40px 48px;">
            <div style="text-align:center;padding:20px 0 10px;"><img src="https://clarity360hq.com/clarity360-icon.png" alt="Clarity 360" width="80" height="80" style="border-radius:12px;"/></div>
            <p style="margin:0 0 20px;font-family:'Helvetica Neue',Arial,sans-serif;font-size:15px;color:#374151;line-height:1.7;">
              You have been invited to participate in the <strong style="color:#4f46e5;">Clarity 360 School Climate Survey</strong> for <strong>${escapeHtml(schoolDisplay)}</strong>. This confidential, voice-guided survey takes approximately 15–20 minutes to complete.
            </p>
      ...
      <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;overflow:hidden;">
        ...
        <tr>
          <td style="padding:36px 48px;">
            ...
            <p style="margin:0 0 16px;font-family:'Helvetica Neue',Arial,sans-serif;font-size:15px;color:#374151;line-height:1.7;">
              It is a voice interview and takes about 15 to 20 minutes. You will tap a rating for each statement and then say why in your own words. <strong>Your microphone stays off until you click to speak.</strong>
            </p>
            <p style="margin:0 0 24px;font-family:'Helvetica Neue',Arial,sans-serif;font-size:15px;color:#374151;line-height:1.7;">
...
app.post('/api/generate-quantitative-report', requireAdminJWT, async (req, res) => {
  ...
  try {
    ...
    // GENERATED from the survey role modules — see CLIMATE_QUESTIONS above.
    const QUESTION_TEXT_MAP = {
      students: {
        S1: 'I feel safe at this school.',
        S2: 'Students here settle disagreements without fighting.',
        S3: 'Teachers and staff treat students with respect.',
        S4: 'Students treat each other with respect.',
        S5: 'If I report bullying, in person or online, an adult will do something about it.',
        S6: 'The rules at this school are fair.',
        S7: 'Bullying, in person or online, is rare at this school.',
        ...
        EMG1: 'This school is prepared to handle an emergency.',
        DSC1: 'Students at this school are disciplined fairly, no matter who they are.',
        SUB1: 'Alcohol and drug use is rare at this school.',
        CON1: 'When someone raises a concern here, it is taken seriously.',
        MH1: 'If I needed help with how I was feeling, I could get it at this school.',
        VOI1: 'My input is valued when decisions are made.',
        EXP1: 'Adults at this school expect every student to do well.',
        OVR1: 'Overall, this is a good school.',
      },
      teachers: {
        S1: 'I feel safe at this school.',
        ...
        S5: 'I am comfortable reporting safety concerns to administrators.',
        S6: 'Adults at this school try to stop bullying, in person or online, when they know about it.',
        S7: 'When in-person or online bullying is reported at this school, it gets resolved.',
        E1: 'I feel like I belong at this school.',
        ...
        E3: 'My input is valued when decisions are made.',
        E4: 'I receive feedback that helps me grow as an educator.',
      ...
      staff: {
        ...
        S3: 'Students treat each other with respect.',
        S4: 'Adults at this school try to stop bullying, in person or online.',
        ...
        EMG1: 'This school is prepared to handle an emergency.',
        S8: 'Teachers and staff treat students with respect.',
        DSC1: 'Students at this school are disciplined fairly, no matter who they are.',
        SUB1: 'Alcohol and drug use is rare at this school.',
        CON1: 'When someone raises a concern here, it is taken seriously.',
        EXP1: 'Adults at this school expect every student to do well.',
      ...
      parents: {
        ...
        S4: 'The school deals effectively with bullying, in person or online.',
        S5: 'I am comfortable reporting safety concerns to administrators.',
        ...
        E5: 'My input is valued when decisions are made.',
        ...
        EN3: 'The school building and grounds are clean and well maintained.',
    ...
    // ── 7. Domain grouping ────────────────────────────────────────────────────
    const SCHOOL_CLIMATE_DOMAINS = ['safety', 'engagement', 'environment', 'ai_readiness', 'overall'];
